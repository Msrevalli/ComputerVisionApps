...
# Custom video transformer for object detection
...
# Start WebRTC video streaming (works in Streamlit Cloud)
webrtc_streamer(key="object-detection", video_transformer_factory=ObjectDetection)
